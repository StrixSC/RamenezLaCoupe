<script lang="ts">
    ...
    function drawLeftRectangle(margin,yScale,xScale1,rectangle,svg) {
      ...
      .attr("transform", `translate(${rectX}, ${rectY + rectHeight/2}) scale(-1, 1) translate(${-rectX}, ${-(rectY + rectHeight/2)})`);
      
    }

    function drawLeftDashedRectangle(margin,yScale,xScale1,topRect,downRect,svg) {
      ...
      .style("stroke", "black")
      .style("stroke-width", 2)
      .attr("transform", `translate(${topRectX}, ${topRectY + topRectHeight/2}) scale(-1, 1) translate(${-topRectX}, ${-(topRectY + topRectHeight/2)})`);
      ...
      .style("stroke", "black")
      .style("stroke-width", 2)
      .attr("transform", `translate(${topRectX}, ${downRectY + downRectHeight/2}) scale(-1, 1) translate(${-topRectX}, ${-(downRectY + downRectHeight/2)})`);
    }
    ...
    function drawRightDashedRectangle(margin,yScale,xScale1,topRect,downRect,svg) {
    ...
    onMount(async ()=> {
        ...
        drawLeftRectangle(params.margin,params.yScale,params.xScale1,leftFullRect,params.svg);  
        ...
        drawLeftDashedRectangle(params.margin,params.yScale,params.xScale1,topDashedRect,downDashedRect,params.svg);  
        
        const rightFullRect={
          x:againstFranceSoT[0],
          y:againstFranceCMP[0]
        }
        drawRightRectangle(params.margin,params.yScale,params.xScale1,rightFullRect,params.svg);
        ...
        drawRightDashedRectangle(params.margin,params.yScale,params.xScale1,rtopDashedRect,rdownDashedRect,params.svg);
    });
</script>



<h1>Ceci est la viz2 OKKOKOKO</h1>
<svg id="graph" width="1900" height="600">
  <rect x="460" y="30" width="900" height="500" style="fill: white; stroke: black; stroke-width: 2;"></rect>
</svg>
